VERSION 5.00
Begin VB.Form frmDeltaViewer 
   Caption         =   "Delta Viewer"
   ClientHeight    =   4560
   ClientLeft      =   48
   ClientTop       =   276
   ClientWidth     =   6708
   ...
   End
End
Attribute VB_Name = "frmDeltaViewer"
...
'=========================================================================
Option Explicit
Private Const MODULE_NAME As String = "frmDeltaViewer"

Private m_oRenderer             As cIconRenderer
...
Private Sub Form_Initialize()
    Set m_oRenderer = New cIconRenderer
End Sub
